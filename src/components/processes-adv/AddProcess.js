    ...
    return(
      <div>
        <form onSubmit={this.handleFormSubmit}>
          ...
          <label>Cliente:</label>
          <input name="customer" value={this.state.customer} onChange={ e => this.handleChange(e)} />
